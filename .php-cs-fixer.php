...
$rules = [
    ...
    'native_function_invocation' => [
        ...
        'exclude' => [
            ...
            'get_class', 'func_get_args', 'call_user_func', 'is_object', 'sprintf',
            'function_exists', 'assert', 'is_bool', 'abort_unless', 'is_float',
            'is_scalar', 'class_alias', 'dirname',
        ],
    ],
...
$finder = Finder::create()
    ...
    ->notName([
        ...
        '*User.php', 'Middleware/*.php', '*Test.php',
    ])
...
return (new Config())
    ...
    ->setUsingCache(true)
    ->setCacheFile(__DIR__ . '/storage/.php_cs')
    ->setFinder($finder)
    ->setRules($rules);
